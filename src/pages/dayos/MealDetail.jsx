    ...
    <div className="pb-2">
      ...
      <div className="container text-gray-700 w-11/12 mx-auto">
        ...
        <div className=" w-full flex items-start flex-col md:flex-row md:items-center justify-between gap-4 md:gap-0 py-8">
          ...
          <button className=" bg-green-900 rounded-lg text-white text-sm font-semibold py-2 px-3">
          ...
          <div>
            <div className="w-full h-100 relative">
              <span className="flex gap-2 absolute left-4 top-5">
                <p className="text-green-950 font-semibold text-[10px] md:text-3 items-center justify-center bg-gray-200/70 px-2 py-1 rounded-2xl">
                  Dinner
                </p>
                <p className="text-green-950 font-semibold text-[10px] md:text-3 items-center justify-center bg-gray-200/70 px-2.5 py-1 rounded-2xl">
                  450 Kcal
                </p>
              </span>
          ...
          <div className="w-full flex flex-col md:flex gap-4">
            ...
            <div className=" bg-gray-200 p-5 rounded-2xl w-full h-[80%]">
              <span className="w-full flex justify-between">
                ...
                <span className="px-2 py-1 bg-gray-300 rounded-lg text-nowrap font-semibold">
                  10 Items
                </span>
              </span>
            ...
            <div className="w-full bg-green-950 text-gray-200 rounded-lg flex flex-col gap-3 p-4">
              ...
              <div className="w-full flex flex-col md:flex-row justify-between gap-4">
                {data?.map((weight, index) => (
                  <div
                    key={index}
                    className="bg-green-900 w-full  px-5 py-2 flex items-center rounded "
                  >
